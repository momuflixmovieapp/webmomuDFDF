          ...
          Align(
            ...
            child: Padding(
              ...
              child: InkWell(
                ...
                onTap: () async {
                  logFirebaseEvent('EDIT_USER_COMP_imageBorder_ON_TAP');
                  logFirebaseEvent('imageBorder_upload_file_to_firebase');
          ...
          Align(
            ...
            child: Padding(
              ...
              child: FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('EDIT_USER_COMP_Button-Login_ON_TAP');
                  ...
                  await currentUserReference!.update(createUsersRecordData(
                    ...
                    photoUrl: _model.isDataUploading != null
