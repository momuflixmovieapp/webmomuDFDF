...
import 'schema/merchant_record.dart';
...
export 'schema/merchant_record.dart';
...
/// Functions to query MerchantRecords (as a Stream and as a Future).
Future<int> queryMerchantRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      MerchantRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<MerchantRecord>> queryMerchantRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      MerchantRecord.collection,
      MerchantRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<MerchantRecord>> queryMerchantRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
