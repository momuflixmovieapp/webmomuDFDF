...
class _ProfileEditingWidgetState extends State<ProfileEditingWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'ProfileEditing'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('PROFILE_EDITING_ProfileEditing_ON_INIT_S');
      logFirebaseEvent('ProfileEditing_set_dark_mode_settings');
              ...
              children: [
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'PROFILE_EDITING_Container_tvamilnx_ON_TA');
                                  ...
                                  await currentUserReference!
                                    ...
                                    photoUrl: valueOrDefault<String>(
                                      currentUserPhoto,
                                      'https://i.pinimg.com/736x/95/7f/99/957f9919571ec87b90c7a0b0b4967a2f.jpg',
                                    ),
                                  ));
                                },
                                child: Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: AuthUserStreamWidget(
                                      builder: (context) => InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'PROFILE_EDITING_Image_gdge2h7s_ON_TAP');
                                          logFirebaseEvent(
                ...
                Padding(
                  ...
                  child: InkWell(
                    ...
                    highlightColor: Colors.transparent,
                    onTap: () async {
                      logFirebaseEvent('PROFILE_EDITING_contentView_1_ON_TAP');
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'PROFILE_EDITING_GO_TO_H_O_M_E_BTN_ON_TAP');
